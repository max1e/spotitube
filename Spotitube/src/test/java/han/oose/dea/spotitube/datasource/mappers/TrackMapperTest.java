...
public class TrackMapperTest {
    ...
    class ToDTOTest {
        ...
        public void testToDTOMapsResultset() {
            try {
                // Arrange
                ...
                // Act
                var tracks = sut.toDTO(mockedResultset);
        ...
        @Test
        @DisplayName("Test toDTO() returns the right amount of tracks")
        public void testToDTOReturnsTheRightAmountOfTracks() {
            try {
                // Arrange
